...
public class CustomSecurityUser extends AccountHolder implements UserDetails {
    private static final long serialVersionUID = -4381938875186527688L;

    /** CustomerSecurity Constructor
     * @param user a AccountHolder element
     */

    public CustomSecurityUser(AccountHolder user) {
